<!--
<p align="center">
  <img src="https://github.com/cthoyt/snekpack-demo/raw/main/docs/source/logo.png" height="150">
</p>
-->
...
<p align="center">
    <a href="https://github.com/cthoyt/snekpack-demo/actions/workflows/tests.yml">
        <img alt="Tests" src="https://github.com/cthoyt/snekpack-demo/actions/workflows/tests.yml/badge.svg" /></a>
    <a href="https://pypi.org/project/snekpack_demo">
        <img alt="PyPI" src="https://img.shields.io/pypi/v/snekpack_demo" /></a>
    <a href="https://pypi.org/project/snekpack_demo">
        <img alt="PyPI - Python Version" src="https://img.shields.io/pypi/pyversions/snekpack_demo" /></a>
    <a href="https://github.com/cthoyt/snekpack-demo/blob/main/LICENSE">
        <img alt="PyPI - License" src="https://img.shields.io/pypi/l/snekpack_demo" /></a>
    <a href='https://snekpack_demo.readthedocs.io/en/latest/?badge=latest'>
        <img src='https://readthedocs.org/projects/snekpack_demo/badge/?version=latest' alt='Documentation Status' /></a>
    <a href="https://codecov.io/gh/cthoyt/snekpack-demo/branch/main">
        <img src="https://codecov.io/gh/cthoyt/snekpack-demo/branch/main/graph/badge.svg" alt="Codecov status" /></a>  
    <a href="https://github.com/cthoyt/cookiecutter-python-package">
        <img alt="Cookiecutter template from @cthoyt" src="https://img.shields.io/badge/Cookiecutter-snekpack-blue" /></a>
    <a href='https://github.com/psf/black'>
        <img src='https://img.shields.io/badge/code%20style-black-000000.svg' alt='Code style: black' /></a>
    <a href="https://github.com/cthoyt/snekpack-demo/blob/main/.github/CODE_OF_CONDUCT.md">
...
The snekpack_demo command line tool is automatically installed. It can
...
[PyPI](https://pypi.org/project/snekpack_demo/) with:
...
[CONTRIBUTING.md](https://github.com/cthoyt/snekpack-demo/blob/master/.github/CONTRIBUTING.md)
...
[GitHub Action](https://github.com/cthoyt/snekpack-demo/actions?query=workflow%3ATests).
...
to https://zenodo.org/account/settings/github/repository/cthoyt/snekpack-demo
...
1. Uses [Bump2Version](https://github.com/c4urself/bump2version) to switch the version number in
   the `pyproject.toml`, `CITATION.cff`, `src/snekpack_demo/version.py`,
...
1. Navigate
   to https://github.com/cthoyt/snekpack-demo/releases/new
